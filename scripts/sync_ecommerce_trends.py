...
# 8 大核心欧美服装细分类目 (标准 Amazon Fashion US GP 路径)
CATEGORIES = [
    {
        "key": "dresses",
        "name_en": "Dresses",
    ...
    },
    {
        ...
        "name_cn": "运动与套装",
        "url": "https://www.amazon.com/gp/bestsellers/fashion/1045028/"
    },
    {
        "key": "swimwear",
        "name_en": "Swimwear & Beach",
        "name_cn": "泳装与沙滩服",
        "url": "https://www.amazon.com/gp/bestsellers/fashion/1046674/"
    }
]
...
def build_prompt_recipe(title: str, category_en: str) -> str:
    ...
    return (
        ...
        f"professional studio lighting, trending on Amazon Fashion, 8k resolution, photorealistic"
    )

def scrape_category(cat_info: dict, max_items: int = 20) -> list:
    items = []
    seen_images = set()
            ...
            for card in cards:
                ...
                if title_el and img_el:
                    ...
                    items.append({
                        ...
                        "tags": ["Amazon Bestseller", cat_info['name_en'], "Spring/Summer 2026"],
...
def main():
    ...
    # 抓取 8 大服装核心品类 (每类 20 款，共 160 款)
    for cat in CATEGORIES:
        cat_items = scrape_category(cat, max_items=20)
    ...
    print(f"[+] Successfully saved {len(all_products)} items across {len(categories)} categories to {out_file}!")
